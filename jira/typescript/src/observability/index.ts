/**
 * Observability components for Jira client following SPARC specification.
 *
...
/**
 * Metric names for Jira operations.
 */
export const MetricNames = {
  // Request metrics
  OPERATIONS_TOTAL: 'jira_operations_total',
  OPERATION_LATENCY: 'jira_operation_latency_seconds',
  ERRORS_TOTAL: 'jira_errors_total',

  // Issue metrics
  ISSUES_CREATED: 'jira_issues_created_total',
  ISSUES_UPDATED: 'jira_issues_updated_total',
  ISSUES_DELETED: 'jira_issues_deleted_total',

  // Transition metrics
  TRANSITIONS_TOTAL: 'jira_transitions_total',

  // Search metrics
  SEARCH_QUERIES_TOTAL: 'jira_search_queries_total',
  SEARCH_RESULTS_TOTAL: 'jira_search_results_total',

  // Webhook metrics
  WEBHOOK_EVENTS_TOTAL: 'jira_webhook_events_total',
  WEBHOOK_VALIDATION_FAILURES: 'jira_webhook_validation_failures_total',

  // Rate limit metrics
  RATE_LIMIT_HITS: 'jira_rate_limit_hits_total',
  RATE_LIMITER_QUEUE_SIZE: 'jira_rate_limiter_queue_size',

  // Circuit breaker metrics
  CIRCUIT_BREAKER_STATE: 'jira_circuit_breaker_state',
  CIRCUIT_BREAKER_TRIPS: 'jira_circuit_breaker_trips_total',

  // Bulk operation metrics
  BULK_OPERATIONS_TOTAL: 'jira_bulk_operations_total',
  BULK_ITEMS_PROCESSED: 'jira_bulk_items_processed_total',
  BULK_ITEMS_FAILED: 'jira_bulk_items_failed_total',
} as const;
