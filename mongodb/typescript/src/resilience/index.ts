/**
 * Resilience components for MongoDB client following SPARC specification.
 *
...
export class RateLimiter {
  ...
  constructor(config: RateLimitConfig = DEFAULT_RATE_LIMIT_CONFIG) {
    ...
    this.currentRate = config.operationsPerSecond;
  ...
  handleRateLimitResponse(_retryAfterMs: number): void {
    ...
    if (this.config.adaptiveRateLimit) {
      // Exponentially reduce rate on repeated rate limits
