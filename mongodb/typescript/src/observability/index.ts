/**
 * Observability components for MongoDB client following SPARC specification.
 *
...
export class ConsoleLogger implements Logger {
  ...
  constructor(options: {
    ...
    this.redactKeys = new Set(options.redactKeys ?? ['token', 'secret', 'password', 'apiKey']);
  }
...
/**
 * Metric names for MongoDB operations.
 */
export const MetricNames = {
  // General operation metrics
  OPERATIONS_TOTAL: 'mongodb_operations_total',
  OPERATION_LATENCY: 'mongodb_operation_latency_ms',
  ERRORS_TOTAL: 'mongodb_errors_total',

  // Connection metrics
  CONNECTIONS_TOTAL: 'mongodb_connections_total',
  CONNECTIONS_ACTIVE: 'mongodb_connections_active',
  CONNECTION_ERRORS: 'mongodb_connection_errors_total',
  POOL_SIZE: 'mongodb_pool_size',

  // Document operation metrics
  DOCUMENTS_READ: 'mongodb_documents_read_total',
  DOCUMENTS_WRITTEN: 'mongodb_documents_written_total',

  // Query metrics
  QUERIES_TOTAL: 'mongodb_queries_total',
  AGGREGATIONS_TOTAL: 'mongodb_aggregations_total',

  // Transaction metrics
  TRANSACTIONS_TOTAL: 'mongodb_transactions_total',
  TRANSACTIONS_COMMITTED: 'mongodb_transactions_committed_total',
  TRANSACTIONS_ABORTED: 'mongodb_transactions_aborted_total',

  // Bulk operation metrics
  BULK_OPERATIONS_TOTAL: 'mongodb_bulk_operations_total',
  BULK_ITEMS_PROCESSED: 'mongodb_bulk_items_processed_total',

  // Change stream metrics
  CHANGE_STREAM_EVENTS: 'mongodb_change_stream_events_total',

  // Rate limit metrics
  RATE_LIMIT_HITS: 'mongodb_rate_limit_hits_total',

  // Circuit breaker metrics
  CIRCUIT_BREAKER_STATE: 'mongodb_circuit_breaker_state',
  CIRCUIT_BREAKER_TRIPS: 'mongodb_circuit_breaker_trips_total',
} as const;
