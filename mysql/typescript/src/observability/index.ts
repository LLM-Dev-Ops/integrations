/**
 * Observability components for MySQL client following SPARC specification.
 *
...
export class ConsoleLogger implements Logger {
  ...
  constructor(options: {
    ...
    this.redactKeys = new Set(options.redactKeys ?? ['password', 'secret', 'token', 'apiKey']);
  }
...
/**
 * Metric names for MySQL operations following SPARC specification.
 */
export enum MysqlMetricNames {
  // Connection pool metrics
  CONNECTIONS_TOTAL = 'mysql.connections.total',
  CONNECTIONS_ACTIVE = 'mysql.connections.active',
  CONNECTIONS_IDLE = 'mysql.connections.idle',
  CONNECTIONS_WAITING = 'mysql.connections.waiting',
  CONNECTIONS_CREATED = 'mysql.connections.created',
  CONNECTIONS_CLOSED = 'mysql.connections.closed',
  CONNECTIONS_ACQUIRE_TIME = 'mysql.connections.acquire_time',

  // Query metrics
  QUERIES_COUNT = 'mysql.queries.count',
  QUERIES_LATENCY_MS = 'mysql.queries.latency_ms',
  QUERIES_ERRORS = 'mysql.queries.errors',
  QUERIES_SLOW = 'mysql.queries.slow',

  // Transaction metrics
  TRANSACTIONS_COUNT = 'mysql.transactions.count',
  TRANSACTIONS_DURATION_MS = 'mysql.transactions.duration_ms',
  TRANSACTIONS_ROLLBACKS = 'mysql.transactions.rollbacks',

  // Replica metrics
  REPLICA_LAG_MS = 'mysql.replica.lag_ms',
  REPLICA_QUERIES = 'mysql.replica.queries',

  // Circuit breaker metrics
  CIRCUIT_BREAKER_STATE = 'mysql.circuit_breaker.state',
}
...
export class InMemoryMetricsCollector implements MetricsCollector {
  ...
  getEntriesByName(name: string): MetricEntry[] {
...
export class InMemoryTracer implements Tracer {
  ...
  /** Gets spans with errors */
  getErrorSpans(): InMemorySpanContext[] {
 ...
 * Use this when you don't need observability (e.g., in tests that don't check telemetry).
 */
 ...
 * Use this when you want to verify logging, metrics, and traces in tests.
 */
