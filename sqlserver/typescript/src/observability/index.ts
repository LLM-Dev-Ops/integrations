/**
 * Observability components for SQL Server client following SPARC specification.
 *
...
export class InMemoryLogger implements Logger {
  ...
  child(context: Record<string, unknown>): Logger {
    ...
    (childLogger as unknown as { entries: LogEntry[] }).entries = this.entries;
    return childLogger;
  }
...
/**
 * Metric names for SQL Server operations.
 */
export const MetricNames = {
  // Query metrics
  QUERIES_TOTAL: 'sqlserver_queries_total',
  QUERY_DURATION_SECONDS: 'sqlserver_query_duration_seconds',
  ROWS_RETURNED_TOTAL: 'sqlserver_rows_returned_total',
  ROWS_AFFECTED_TOTAL: 'sqlserver_rows_affected_total',

  // Transaction metrics
  TRANSACTIONS_TOTAL: 'sqlserver_transactions_total',
  TRANSACTION_DURATION_SECONDS: 'sqlserver_transaction_duration_seconds',

  // Connection pool metrics
  POOL_CONNECTIONS: 'sqlserver_pool_connections',
  POOL_ACQUIRE_DURATION_SECONDS: 'sqlserver_pool_acquire_duration_seconds',

  // Routing metrics
  ROUTING_DECISIONS_TOTAL: 'sqlserver_routing_decisions_total',

  // Error metrics
  ERRORS_TOTAL: 'sqlserver_errors_total',

  // Replication metrics
  REPLICA_LAG_SECONDS: 'sqlserver_replica_lag_seconds',
} as const;
