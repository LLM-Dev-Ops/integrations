/**
 * HTTP Transport Layer for Azure Files
 *
 * Provides HTTP request/response handling for Azure Files operations.
 */
 ...
 */
export function isSuccess(response: HttpResponse | StreamingHttpResponse): boolean {
...
export function getHeader(
  response: HttpResponse | StreamingHttpResponse | Record<string, string>,
  name: string
): string | undefined {
  const headers = "headers" in response && typeof response.headers === "object"
    ? response.headers
 ...
 */
export function getRequestId(response: HttpResponse | StreamingHttpResponse): string | undefined {
  return getHeader(response, "x-ms-request-id");
}

/**
 * Get ETag from response.
 */
export function getETag(response: HttpResponse | StreamingHttpResponse): string | undefined {
 ...
 */
export function getContentLength(response: HttpResponse | StreamingHttpResponse): number | undefined {
 ...
 */
export function getContentType(response: HttpResponse | StreamingHttpResponse): string | undefined {
 ...
 */
export function getLastModified(response: HttpResponse | StreamingHttpResponse): Date | undefined {
  const value = getHeader(response, "last-modified");
