/**
 * Azure Cognitive Search Authentication Providers
 *
 * Handles API Key and Azure AD (Entra ID) authentication for Azure Cognitive Search.
 */
...
export class AzureAdAuthProvider implements AuthProvider {
  ...
  private readonly scope = 'https://search.azure.com/.default';
  ...
  private async acquireTokenManagedIdentity(): Promise<CachedToken> {
    ...
    imdsUrl.searchParams.set('resource', 'https://search.azure.com');
 ...
 */
export function createAuthProvider(apiKey?: string, azureAdCredentials?: AzureAdCredentials): AuthProvider {
