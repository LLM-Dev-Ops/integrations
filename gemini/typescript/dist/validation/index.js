 ...
 */
function validateContent(content, fieldPath) {
    const errors = [];
 ...
 * @returns Array of validation errors
 */
function validatePart(part, fieldPath) {
    const errors = [];
 ...
 * @throws {ValidationError} If validation fails
 */
export function validateGenerateContentRequest(request) {
    const errors = [];
 ...
 * @throws {ValidationError} If validation fails
 */
export function validateEmbedContentRequest(request) {
    const errors = [];
 ...
 * @throws {ValidationError} If batch size exceeds maximum
 */
export function validateBatchSize(items, maxSize, fieldName) {
