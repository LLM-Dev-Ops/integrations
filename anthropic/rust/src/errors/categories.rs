...
/// Detail about a specific validation failure
#[derive(Debug, Clone)]
...
pub enum ValidationError {
    ...
    #[error("Content too large: max size is {max_size} bytes, got {actual_size} bytes")]
    ContentTooLarge { max_size: u64, actual_size: u64 },
}
