 ...
 */
export function createThinkingConfig(budgetTokens) {
    if (budgetTokens <= 0) {
 ...
 */
export function withThinking(request, budgetTokens) {
    return {
        ...request,
 ...
 */
export function getThinkingText(content) {
 ...
 */
export function hasThinkingBlocks(content) {
 ...
 */
export function estimateThinkingTokens(content) {
