 ...
 */
export function createComputerTool(width, height, displayNumber = 1) {
    if (width <= 0 || height <= 0) {
 ...
 */
export function createComputerUseTools(screenWidth, screenHeight) {
    return [
...
export class ComputerToolResultBuilder {
     ...
     * @returns This builder for chaining
     */
    withScreenshot(base64Png, mediaType = 'image/png') {
 ...
 */
export function createComputerToolResult(toolUseId) {
 ...
 * @returns ComputerToolResult
 */
export function createTextToolResult(toolUseId, text, isError = false) {
 ...
 * @returns ComputerToolResult
 */
export function createScreenshotToolResult(toolUseId, text, screenshot, isError = false) {
 ...
 */
export function validateComputerTool(tool) {
