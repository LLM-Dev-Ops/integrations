 ...
 */
export function createPdfContent(pdfBase64) {
 ...
 * @returns DocumentContent object for use in messages
 */
export function createPdfContentFromBuffer(buffer) {
 ...
 * @returns DocumentContent object for use in messages
 */
export function createPdfContentFromArrayBuffer(arrayBuffer) {
 ...
 * @returns DocumentContent object for use in messages
 */
export function createPdfContentFromBytes(bytes) {
    if (!bytes || bytes.length === 0) {
        throw new Error('PDF bytes cannot be empty');
    }
    return createPdfContentFromArrayBuffer(bytes.buffer);
}
/**
 ...
 */
export function validatePdfBase64(base64) {
    try {
        ...
        if (binary.length < 5)
            return false;
        return (binary.charCodeAt(0) === 0x25 && // %
 ...
 */
export function estimatePdfSize(base64) {
 ...
 */
export function isPdfWithinSizeLimit(base64, maxBytes = 32 * 1024 * 1024) {
    return estimatePdfSize(base64) <= maxBytes;
}
//# sourceMappingURL=pdf-support.js.map