...
import type { CreateMessageRequest, CountTokensRequest, MessageParam } from './types.js';

export function validateCreateMessageRequest(request: CreateMessageRequest): void {
  const errors: string[] = [];
...
export function validateCountTokensRequest(request: CountTokensRequest): void {
  const errors: string[] = [];
...
function validateMessage(msg: MessageParam, idx: number, errors: string[]): void {
  if (!msg.role) {
...
function validateMessageAlternation(messages: MessageParam[], errors: string[]): void {
...
function validateTool(tool: any, idx: number, errors: string[]): void {
  if (!tool.name) {
...
function validateToolChoice(toolChoice: any, errors: string[]): void {
  if (!toolChoice.type) {
...
function validateThinkingConfig(thinking: any, errors: string[], model?: string): void {
  if (!thinking.type) {
