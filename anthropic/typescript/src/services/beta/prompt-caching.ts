 ...
 */
export function createCacheableSystemPrompt(text: string): SystemPromptWithCache {
 ...
 */
export function createCacheableSystemPrompts(prompts: string[]): SystemPromptWithCache[] {
 ...
 */
export function hasCacheUsage(usage: unknown): usage is Usage & CacheUsage {
  return (
    typeof usage === 'object' &&
    usage !== null &&
 ...
 */
export function getCacheEfficiency(usage: CacheUsage): number {
 ...
 */
export function calculateTokensSaved(usage: CacheUsage): number {
 ...
 */
export function calculateCostSavings(usage: CacheUsage, tokenCostPer1M: number = 3.0): number {
 ...
 */
export function getCacheStats(usage: Usage): {
 ...
 */
export function isCachingEffective(usage: CacheUsage): boolean {
