import type {
  ...
  BatchStatus,
  BatchRequestCounts,
} from '../services/batches/types.js';
import type { CreateMessageRequest } from '../services/messages/types.js';

/**
 * Mock factory for creating batch request counts
 */
export function mockBatchRequestCounts(overrides?: Partial<BatchRequestCounts>): BatchRequestCounts {
  return {
    succeeded: 0,
    errored: 0,
    expired: 0,
 ...
 */
export function mockMessageBatch(overrides?: Partial<MessageBatch>): MessageBatch {
  const now = new Date();
 ...
 */
export function mockBatchRequest(overrides?: Partial<BatchRequest>): BatchRequest {
  return {
    custom_id: 'request-1',
    params: {
 ...
 */
export function mockCreateBatchRequest(overrides?: Partial<CreateBatchRequest>): CreateBatchRequest {
  return {
    requests: [
 ...
 */
export function mockBatchListResponse(overrides?: Partial<BatchListResponse>): BatchListResponse {
  return {
    data: [
 ...
 */
export function mockBatchResultItem(overrides?: Partial<BatchResultItem>): BatchResultItem {
  return {
    custom_id: 'request-1',
    result: {
      type: 'succeeded',
 ...
 */
export function mockBatchResultsResponse(count: number = 2): BatchResultsResponse {
 ...
 */
export const BATCH_IN_PROGRESS: MessageBatch = mockMessageBatch({
...
export const BATCH_ENDED: MessageBatch = mockMessageBatch({
  id: 'msgbatch_01ENDED',
...
export const BATCH_CANCELING: MessageBatch = mockMessageBatch({
...
export const BATCH_CANCELED: MessageBatch = mockMessageBatch({
 ...
 */
export const BATCH_RESULT_SUCCEEDED: BatchResultItem = mockBatchResultItem({
...
export const BATCH_RESULT_ERRORED: BatchResultItem = {
...
export const BATCH_RESULT_EXPIRED: BatchResultItem = {
...
export const BATCH_RESULT_CANCELED: BatchResultItem = {
 ...
 */
export function createBatchRequestWithParams(
  customId: string,
 ...
 */
export function createBatchWithStatus(
  status: BatchStatus,
 ...
 */
export function createMixedBatchResults(): BatchResultsResponse {
  return [
