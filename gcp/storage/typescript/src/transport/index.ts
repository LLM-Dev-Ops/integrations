/**
 * HTTP Transport Layer for GCS
 *
 * Provides HTTP request/response handling for GCS operations.
 */
...
/**
 * Get generation from response.
 */
export function getGeneration(response: HttpResponse): string | undefined {
  return getHeader(response, "x-goog-generation");
}

/**
 * Get metageneration from response.
 */
export function getMetageneration(response: HttpResponse): string | undefined {
  return getHeader(response, "x-goog-metageneration");
}
...
export function getRequestId(response: HttpResponse): string | undefined {
  return getHeader(response, "x-guploader-uploadid") ?? getHeader(response, "x-goog-request-id");
}
